...
print("Please wait to collect the newest news .....")
...
news_shuffle.to_csv("Newest_news.csv", index = False) 

df_news = pd.read_csv("Newest_news.csv")
...
with open("Updated_news.pickle", "wb") as output:
    pickle.dump(df_news_95, output)

print("The database for recommendation is available!")